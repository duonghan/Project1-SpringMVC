 ...
 * Generated at: 2017-05-25 03:16:13 UTC
...
public final class product_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<!-- Day la trang SP. Khi nguoi dung nhan SAVE ==>> No chuen toi /product. Với POST -->\r\n");
      out.write("<!-- Vay GET duoc the hien o cho nao a, cứ gõ 1 trang bat ky ==> No la GET, \r\n");
      out.write("\r\n");
      out.write(" POST thuong duoc chi dinh trong <form> thẻ form...==> VÍ dụ:\r\n");
      out.write(" vậy đói với trang này là bao gồm cả POST và get\r\n");
      out.write(" POSt khi mình SUBmit còn get là hiển thị trang à a\r\n");
      out.write(" dung vay\r\n");
      out.write("\r\n");
      out.write("Mọi thao tac cua ngươi dung deu la GET.\r\n");
      out.write("\r\n");
      out.write("Còn khi người ta Click vao Form nhập dữ liệu, .... Rồi nhấn Subit\r\n");
      out.write("nếu form đó chỉ rõ method = POST thì nó sẽ gọi tới trang dc submit với POST!!\r\n");
      out.write("Người dùng ko tự tạo ra POST dc, mà do form này quết đinh\r\n");
      out.write("Mọi thaoo tac ví dụ gõ lên trình dueetj: http://dantri.com ==> Đều là GET!!\r\n");
      out.write("\r\n");
      out.write("vậy giiar sử khi e k có POST mà vẫn submit thì có đc k a ==> Lúc đó nó sẽ gọi tới hàm GET.\r\n");
      out.write(" -->\r\n");
      out.write(" <!-- còn cái này a, cái này cần thiết cho mục đích các form có upload gì đó\r\n");
      out.write(" Trong bài này là upload ảnh. Có thể xem thêm trong ví dụ sau:\r\n");
      out.write(" OK A \r\n");
      out.write(" Neu khong co cai nay ==> Ko the upload, vi no khong biet cach ma hoa du lieu binary ==> thanh text\r\n");
      out.write(" de chuyen di, cái này nói với trình duyệt chuyển dữ liệu ảnh thành text, đính kèm vào trong \r\n");
      out.write(" POST để gửi đi. Vì các dữ liệu đính kèm thường rất lớn. Chỉ có khác biệt vậy\r\n");
      out.write(" Nếu là form thông thường, ko liên quan upload, ko cần chỉ định kiểu mã hóa này.\r\n");
      out.write(" ok a ạ\r\n");
      out.write("  -->\r\n");
      //  form:form
      ...
      // /WEB-INF/bodyfragments/product.jsp(36,0) name = modelAttribute type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005fform_005f0.setModelAttribute("productForm");
      // /WEB-INF/bodyfragments/product.jsp(36,0) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005fform_005f0.setMethod("POST");
      // /WEB-INF/bodyfragments/product.jsp(36,0) name = enctype type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_form_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            // /WEB-INF/bodyfragments/product.jsp(51,7) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_form_005ferrors_005f0.setPath("id");
            // /WEB-INF/bodyfragments/product.jsp(51,7) null
            ...
            // /WEB-INF/bodyfragments/product.jsp(57,7) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_form_005ferrors_005f1.setPath("name");
            // /WEB-INF/bodyfragments/product.jsp(57,7) null
            ...
            // /WEB-INF/bodyfragments/product.jsp(63,7) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_form_005ferrors_005f2.setPath("categoryId");
            // /WEB-INF/bodyfragments/product.jsp(63,7) null
            ...
            // /WEB-INF/bodyfragments/product.jsp(69,7) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_form_005ferrors_005f3.setPath("description");
            // /WEB-INF/bodyfragments/product.jsp(69,7) null
            ...
            // /WEB-INF/bodyfragments/product.jsp(75,7) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_form_005ferrors_005f4.setPath("price");
            // /WEB-INF/bodyfragments/product.jsp(75,7) null
            ...
            // /WEB-INF/bodyfragments/product.jsp(81,7) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
            _jspx_th_form_005ferrors_005f5.setPath("discount");
            // /WEB-INF/bodyfragments/product.jsp(81,7) null
            ...
            out.write("\t\t<tr>\r\n");
            out.write("\t\t\t<td>&nbsp;</td>\r\n");
            out.write("\t\t\t<td><input type=\"submit\" value=\"Gửi\" /> <input type=\"reset\"\r\n");
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/bodyfragments/product.jsp(6,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(42,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not empty productForm.id}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
  ...
  private boolean _jspx_meth_form_005fhidden_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(44,5) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(47,16) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${empty productForm.id}", java.lang.Boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false)).booleanValue());
    int _jspx_eval_c_005fif_005f2 = _jspx_th_c_005fif_005f2.doStartTag();
    if (_jspx_eval_c_005fif_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_form_005finput_005f0(_jspx_th_c_005fif_005f2, _jspx_page_context, _jspx_push_body_count_form_005fform_005f0))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t\t");
        if (_jspx_meth_form_005fhidden_005f1(_jspx_th_c_005fif_005f2, _jspx_page_context, _jspx_push_body_count_form_005fform_005f0))
          return true;
        out.write("\r\n");
        out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_form_005finput_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f2, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  form:input
    ...
    _jspx_th_form_005finput_005f0.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fif_005f2);
    // /WEB-INF/bodyfragments/product.jsp(48,5) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005fhidden_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f2, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
          throws java.lang.Throwable {
    javax.servlet.jsp.PageContext pageContext = _jspx_page_context;
    javax.servlet.jsp.JspWriter out = _jspx_page_context.getOut();
    //  form:hidden
    ...
    _jspx_th_form_005fhidden_005f1.setParent((javax.servlet.jsp.tagext.Tag) _jspx_th_c_005fif_005f2);
    // /WEB-INF/bodyfragments/product.jsp(49,5) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005fhidden_005f1.setPath("newProduct");
  ...
  private boolean _jspx_meth_form_005finput_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(56,7) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(62,7) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005finput_005f2.setPath("categoryId");
  ...
  private boolean _jspx_meth_form_005finput_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(68,7) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(74,7) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(80,7) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005finput_005f5.setPath("discount");
  ...
  private boolean _jspx_meth_form_005finput_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    // /WEB-INF/bodyfragments/product.jsp(93,7) null
    _jspx_th_form_005finput_005f6.setDynamicAttribute(null, "type", "file");
    // /WEB-INF/bodyfragments/product.jsp(93,7) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_form_005finput_005f6.setPath("fileData");
